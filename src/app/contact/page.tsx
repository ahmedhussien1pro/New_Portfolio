...
import { ArrowLeft, Send, Mail, MapPin, CheckCircle, FileDown } from "lucide-react";
        ...
        <div className="md:col-span-5 space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400">
              Have a project, enterprise consulting inquiry, or looking to discuss full-stack software architecture?
            </p>
          </div>
          ...
          <div className="pt-2">
            <a href="/Ahmed_Hussien_CV.pdf" download="Ahmed_Hussien_CV.pdf">
              <Button variant="outline" size="sm" className="w-full gap-2 border-zinc-300 dark:border-zinc-700">
                <FileDown className="h-4 w-4 text-emerald-500" /> Download Ahmed&apos;s CV
              </Button>
            </a>
          </div>
        </div>
            ...
            {submitted ? (
              <div className="py-12 text-center space-y-3">
                ...
                <p className="text-xs text-zinc-500 max-w-xs mx-auto">
                  Thank you! Your message has been recorded. Ahmed will get back to you shortly.
                </p>
                <Button
                  variant="ghost"
                  size="sm"
